...
// Since jest might not be globally available in this context, use a fallback
const jestFn = typeof jest !== "undefined" ? jest.fn : () => () => {};
...
const RunService = {
	IsStudio: () => true, // Default to studio mode for tests - simple function, no jest.fn
	IsClient: () => false,
	IsServer: () => true,
	Heartbeat: {
		Connect: () => ({}),
...
module.exports = {
	Players: mock(),
	RunService, // Use our custom mock instead of mock()
